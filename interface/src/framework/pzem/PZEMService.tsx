...
import { readState, updateState, WEBSOCKET_URL } from './api';
import { useRest } from '../../utils';
import { useWs } from '../../utils/useWs';
import FormLoader from '../../components/loading/FormLoader';

const PZEMService: FC = () => {
  useLayoutTitle("PZEM Control");
  ...
  const { connected, wsData, updateData: updateWsData, disconnect } = useWs<any>(WEBSOCKET_URL);
